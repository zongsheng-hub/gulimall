...
public class CategoryBrandRelationServiceImpl extends ServiceImpl<CategoryBrandRelationDao, CategoryBrandRelationEntity> implements CategoryBrandRelationService {
    ...
    public void updateBrand(Long brandId, String name) {
        ...
        UpdateWrapper<CategoryBrandRelationEntity> brand_id = new UpdateWrapper<CategoryBrandRelationEntity>().eq("brand_id", brandId);

        this.update(categoryBrandRelationEntity,brand_id);
    }
    ...
    public List<BrandEntity> getBrandByCatId(Long catId) {
        ...
        List<BrandEntity> brandEntityList = catelog_id.stream().map(item -> {
